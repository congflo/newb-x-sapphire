...
#define NL_DAY_ZENITH_COL    vec3(0.05,0.32, 0.75)
...
#define NL_RAIN_ZENITH_COL   vec3(0.3,0.5,0.7)*0.8
#define NL_RAIN_HORIZON_COL  vec3(0.8,1.0,1.3)*0.8
...
#define NL_DAWN_HORIZON_COL  vec3(1.5,0.2,0.0)*2.0
