...
#define NL_EXPOSURE 1.12              // [toggle] 0.5 dark ~ 3.0 bright
...
/* Ore glow intensity */
#define NL_GLOW_TEX 4.5           // 0.4 weak ~ 8.0 bright
...
#define NL_CLOUD2_LAYER2_OFFSET 220.0           // 30.0 near ~ 300.0 very high
#define NL_CLOUD2_LAYER2_THICKNESS 3.6          // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_RAIN_THICKNESS 4.0     // 0.7 slim ~ 5.0 fat
#define NL_CLOUD2_LAYER2_STEPS 8                // 3 low quality ~ 16 high quality
#define NL_CLOUD2_LAYER2_SCALE vec2_splat(0.03) // 0.003 large ~ 0.3 tiny
